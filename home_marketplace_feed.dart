...
class _HomeMarketplaceFeedState extends State<HomeMarketplaceFeed>
      ...
      setState(() {
        _listings = listings.map((listing) {
          ...
          return {
            ...
            'isFavorite': _favoriteListings.contains(listingId),
  ...
  Future<void> _loadFavorites() async {
    try {
      ...
      if (authService.isAuthenticated()) {
        ...
        // Handle UUID listing_id as string
  ...
  Future<void> _toggleFavorite(String listingId) async {
    ...
    try {
      ...
      // listingId is already a string (UUID), no need for toString()
      ...
      setState(() {
        ...
        if (index != -1) {
          _listings[index]['isFavorite'] = _favoriteListings.contains(listingId);
        }
      });
    } catch (error) {
                ...
                child: _filteredListings.isEmpty && !_isLoading
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          // Listing ID is already a string
                          final isFavorite = _favoriteListings.contains(listing['id'] as String);
